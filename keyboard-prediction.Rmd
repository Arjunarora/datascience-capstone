...
fourGramChunksFileName <- paste("fourGramChunks_",
                                locale,
                                "_",
...
if (!file.exists("fourGrams_en_US_news_blogs_twitter.rds")){
    ...
    saveRDS(fourGrams, "fourGrams_en_US_news_blogs_twitter.rds")
    rm(fourGrams)
    gc()
    ...
    saveRDS(threeGrams, "threeGrams_en_US_news_blogs_twitter.rds")
    rm(threeGrams)
    gc()
    ...
    saveRDS(twoGrams, "twoGrams_en_US_news_blogs_twitter.rds")
    rm(twoGrams)
    gc()
    ...
    saveRDS(oneGrams, "oneGrams_en_US_news_blogs_twitter.rds")
    rm(oneGrams)
    rm(fourGramChunks)
    gc()
}
...
nGrams <- list(readRDS("oneGrams_en_US_news_blogs_twitter.rds"),
               readRDS("twoGrams_en_US_news_blogs_twitter.rds"),
               readRDS("threeGrams_en_US_news_blogs_twitter.rds"),
               readRDS("fourGrams_en_US_news_blogs_twitter.rds"))
```
